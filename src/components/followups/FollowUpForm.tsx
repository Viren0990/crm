...
export function FollowUpForm({ 
  ...
  const defaultDate = initialData.followUpDate 
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="followUpDate" className="block text-sm font-medium text-gray-700 mb-1">Next Follow-up Date & Time</label>
          <input 
            type="datetime-local" 
            id="followUpDate" 
            name="followUpDate" 
